        ...
        <div className="grid-inner">
          <div className={styles['img-wrap']}>
            <div className={styles['img']}>
              <Image
                src={
                  'https://res.cloudinary.com/dtwk4dm3g/image/upload/v1683002285/big_poppas/award_jwldym.jpg'
                }
                alt="logo"
                fill
            ...
            <div className={styles['star-wrap']}>
              <div className={styles['star']}>
                <Image
                  src={
                    'https://res.cloudinary.com/dtwk4dm3g/image/upload/v1683002283/big_poppas/star-award_cdljcv.svg'
                  }
                  alt="logo"
                  fill
                  sizes="(max-width: 768px) 100vw)"
